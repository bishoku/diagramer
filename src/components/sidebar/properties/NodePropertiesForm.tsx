...
import { DeviconRegistry, getUniqueAllDevicons, getDeviconComponent, findDeviconItem } from '../../../registry/DeviconRegistry';
    ...
    <div className="flex flex-col gap-2">
      ...
      {!isSection && (
        <details className="mt-2 group border border-slate-200 dark:border-slate-800 rounded-xl bg-slate-50/30 dark:bg-slate-900/10 overflow-hidden transition-all duration-200">
          <summary className="flex items-center justify-between p-3 font-semibold text-xs text-slate-700 dark:text-slate-300 cursor-pointer hover:bg-slate-100/50 dark:hover:bg-slate-800/30 list-none focus:outline-none select-none">
          ...
          <div className="p-3 border-t border-slate-100 dark:border-slate-800/60 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full px-2.5 py-1.5 text-xs bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg focus:outline-none focus:border-indigo-500 text-slate-850 dark:text-slate-200"
              />
              {iconSearch && (
                <div className="grid grid-cols-4 gap-1.5 max-h-[140px] overflow-y-auto p-0.5 border border-slate-100 dark:border-slate-800 rounded-lg bg-slate-50/50 dark:bg-slate-950/30">
